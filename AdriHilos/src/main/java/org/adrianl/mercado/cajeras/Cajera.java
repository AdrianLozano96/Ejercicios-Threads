...
public class Cajera implements Runnable {
    ...
    public void run() {
        ...
        System.out.println("La cajera: " + Thread.currentThread().getName() + " Comienza procesando la compra del cliente: "
        ...
        for (int i = 0; i < cliente.getCarro().getProductos().length; i++) {
            ...
            System.out.println("La cajera: " + Thread.currentThread().getName() + " Procesa la compra del cliente: "
                    + cliente.getNumCliente()
                    +" Procesa el producto: " + cliente.getCarro().getProductos()[i].getNumProductos()+
                    " En el tiempo: " + (System.currentTimeMillis() - initialTime) / 1000 + " seg");
        }

        System.out.println("La cajera: " + Thread.currentThread().getName() + " Ha terminado de procesar la compra del cliente "
                + cliente.getNumCliente()
                + " En el tiempo: " + (System.currentTimeMillis() - initialTime) / 1000 + "seg");
